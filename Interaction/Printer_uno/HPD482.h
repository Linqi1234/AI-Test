...
#define IS_ASCII16_EN 	0
//是否打印24号ASCII字符（0：否，1：是）
#define IS_ASCII24_EN 	1

//是否打印36号ASCII字符（0：否，1：是）
#define IS_ASCII18_EN 	1
#define IS_ASCII27_EN   1

#define IS_ASCII29_EN 	0

#define IS_ASCII34_EN 	1
#define IS_ASCII96_EN 	1
#define IS_ASCII103_EN 	0
...
public:
  ...
  void Print_String_big(u8 *onestr,u8 strnum,int sizeh,int sizew);
#endif
};
